    ...
    <form onSubmit={save}>
          ...
          <fieldset style={{borderTop:'none',paddingTop:0}}>
            ...
            <div className="form-grid">
              <div className="field">
                ...
                <input required value={f.employee_no} onChange={set('employee_no')} placeholder="EMP-008" dir="ltr" />
              </div>
              ...
              <div className="field span2">
                ...
                <input value={f.full_name_en || ''} onChange={set('full_name_en')} dir="ltr" />
              </div>
              <div className="field">
                <label>الجنسية</label>
          ...
          <fieldset>
            ...
            <div className="form-grid">
              <div className="field">
                ...
                <select value={f.id_kind || 'iqama'} onChange={set('id_kind')}>
              ...
              <div className="field">
                ...
                <input value={f.id_number || ''} onChange={set('id_number')} dir="ltr" />
              </div>
              <div className="field">
                <label>تاريخ الانتهاء</label>
                <input type="date" value={f.id_expiry || ''} onChange={set('id_expiry')} dir="ltr" />
                <span className="hint">ينبهك النظام قبل الانتهاء بـ٩٠ يوماً</span>
              </div>
              <div className="field">
                <label>رقم الجوال</label>
                <input value={f.mobile || ''} onChange={set('mobile')} dir="ltr" placeholder="05xxxxxxxx" />
              </div>
              <div className="field span2">
                <label>البريد الإلكتروني</label>
                <input type="email" value={f.email || ''} onChange={set('email')} dir="ltr" />
              </div>
            </div>
          </fieldset>
            ...
            <div className="form-grid">
              ...
              <div className="field">
                ...
                <input type="number" step="0.001" min="0" max="1"
                       value={f.commission_rate} onChange={set('commission_rate')} dir="ltr" />
                <span className="hint">0.025 تعني ٢.٥٪ من ربح المشاريع التي يجلبها</span>
              </div>
            </div>
          </fieldset>
          ...
          <fieldset>
            ...
            <div className="form-grid">
              <div className="field">
                ...
                <input type="number" min="0" step="0.01" value={f.basic_salary} onChange={set('basic_salary')} dir="ltr" />
              </div>
              <div className="field">
                <label>بدل السكن</label>
                <input type="number" min="0" step="0.01" value={f.housing_allowance} onChange={set('housing_allowance')} dir="ltr" />
              </div>
              <div className="field">
                <label>بدل النقل</label>
                <input type="number" min="0" step="0.01" value={f.transport_allowance} onChange={set('transport_allowance')} dir="ltr" />
              </div>
              <div className="field">
                <label>بدلات أخرى</label>
                <input type="number" min="0" step="0.01" value={f.other_allowance} onChange={set('other_allowance')} dir="ltr" />
              </div>
              <div className="field span2">
          ...
          <fieldset>
            ...
            <div className="form-grid">
              <div className="field span2">
                ...
                <input value={f.iban || ''} onChange={set('iban')} dir="ltr" placeholder="SA00 0000 0000 0000 0000 0000" />
              </div>
              <div className="field">
              ...
              <div className="field">
                ...
                <input value={f.gosi_number || ''} onChange={set('gosi_number')} dir="ltr" />
              </div>
              <div className="field span2">
                <label>ملاحظات</label>
      ...
      <div className="rowsplit" style={{marginTop:18}}>
        <button className="btn" type="submit" disabled={busy}>
          {busy ? 'جارٍ الحفظ…' : (id ? 'حفظ التعديلات' : 'إضافة الموظف')}
        </button>

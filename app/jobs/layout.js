export const metadata = {
  ...
  openGraph: {
    title: 'فرص العمل | أركان المكان للمقاولات',
    description: 'بوابة التوظيف الرسمية لأركان المكان للمقاولات',
    type: 'website',
  },
};
  ...
  return (
    <div style={{minHeight:'100vh',background:'#f3f4f4',color:'#3f4346'}}>
      <header style={{background:'#fff',borderBottom:'1px solid #e3e5e6'}}>
        <div style={{maxWidth:920,margin:'0 auto',padding:'22px 20px 18px',display:'flex',alignItems:'center',justifyContent:'space-between',gap:24,flexWrap:'wrap'}}>
          <img src="/brand/arkan-logo.svg" alt="أركان المكان - ARKAN AL MAKAN" style={{width:150,height:'auto',display:'block'}} />
      ...
      <main>{children}</main>
      <footer style={{maxWidth:920,margin:'0 auto',padding:'10px 20px 34px',textAlign:'center',fontSize:12.5,color:'#777d80'}}>
        أركان المكان للمقاولات · بوابة التوظيف الرسمية
      </footer>
    </div>
  );
}

export const metadata = {
  ...
  openGraph: { title: 'فرص العمل | أركان المكان للمقاولات', description: 'بوابة التوظيف الرسمية لأركان المكان للمقاولات', type: 'website', siteName:'أركان المكان للمقاولات' },
};
...
export default function CareersLayout({ children }) {
  return (
    <div style={{minHeight:'100vh',background:'#f3f4f4',color:'#3f4346'}}>
      ...
      <main>{children}</main>
      <footer style={{maxWidth:920,margin:'0 auto',padding:'10px 20px 34px',textAlign:'center',fontSize:12.5,color:'#777d80'}}>أركان المكان للمقاولات · ARKAN AL MAKAN CONTRACTING</footer>
    </div>
  );
}

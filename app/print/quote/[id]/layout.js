      ...
      <style jsx global>{`
        ...
        @media print{
          ...
          /* Chromium can round an exact 297mm CSS box a fraction beyond A4 and push the footer to a blank page.
             Keep the logical A4 canvas while reserving a tiny print-only rounding tolerance. */
          .constitution-paged-sheet.sheet{height:296.5mm!important;max-height:296.5mm!important;min-height:296.5mm!important}
          .constitution-paged-sheet.sheet .constitution-paged-content{height:296.5mm!important}
        }
      `}</style>
    </>
  );

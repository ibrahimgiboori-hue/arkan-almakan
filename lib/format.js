// كل الأرقام والتواريخ في المطبوعات والشاشات إنجليزية موحّدة: 1,234.50 و 30/07/2026
...
export const moneyOrDash = (n) =>
  n === null || n === undefined || n === '' ? '—' : money(n);
...
export const dateTimeAr = (value) => {
  if (!value) return '—';
  const d = new Date(value);
  if (Number.isNaN(d.getTime())) return dateAr(value);

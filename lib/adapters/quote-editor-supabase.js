...
export const quoteEditorSupabaseRepository=Object.freeze({
  ...
  async loadPrintAssets(){
    const {data,error}=await supabase.from('app_settings')
      .select('stamp_image_path,signature_image_path,letterhead_image_path,header_image_path,watermark_image_path,footer_image_path,header_height_mm,footer_height_mm,print_white_veil_opacity')
      .eq('id',1)
      .maybeSingle();

...
export const ATTENDANCE_PRESENTATION_INFRASTRUCTURE_DEBT = Object.freeze([
  ...
  Object.freeze({
    path:'app/dashboard/attendance/external-review/page.js',
    scope:'external-review',
    retirement:'replace-direct-review-queries-and-rpcs-with-external-attendance-review-service',
  }),
  Object.freeze({
    path:'app/dashboard/attendance/manual-resolution/page.js',
    scope:'manual-resolution',
    retirement:'move-manual-resolution-reads-and-writes-behind-an-adapter-and-use-case-service',
  }),
  Object.freeze({
    path:'components/attendance/AttendanceClientExcelReport.js',
    scope:'report-projection',
    retirement:'feed-report-a-stable-read-model-instead-of-querying-storage',
  }),
  Object.freeze({

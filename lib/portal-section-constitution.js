...
export const PORTAL_SECTION_CATALOG = Object.freeze({
  ...
  finance: Object.freeze({
    ...
    treasury: section('finance', 'treasury', 'الخزينة والسندات', 'حسابات الصندوق والبنوك ودفاتر سندات القبض والصرف المرقمة والحركات الداخلة والخارجة.', ['finance.treasury.view'], 'finance-treasury'),

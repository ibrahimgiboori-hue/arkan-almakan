...
// لا نعرض مساحة ناقصة لمجرد ملء الواجهة، ولا نكرر الوجهة في أكثر من موضع داخل المستوى نفسه.
...
// الصلاحيات المطلوبة للوجهات القديمة الموجودة مسبقًا في البوابات.
...
// هندسة الإدارة داخل كل بوابة. هذه القائمة هي المصدر الواحد لتصنيف الوجهات.
export const PORTAL_MANAGEMENT_SECTIONS = Object.freeze({
  workforce: Object.freeze([
    Object.freeze({
      key: 'people', label: 'الأفراد', shortLabel: 'الأفراد',
      description: 'ملف الموظف أثناء الخدمة: بياناته وإجازاته ووثائقه وعلاقاته الوظيفية ونهاية خدمته.',
      hrefs: Object.freeze([
        '/dashboard/employees', '/dashboard/leaves',
  ...
  admin: Object.freeze([
    ...
    Object.freeze({
      ...
      description: 'مسارات الاعتماد وسجل التدقيق والقواميس واستمرارية النظام.',
      hrefs: Object.freeze([
        portalSectionHref('admin','workflows'), portalSectionHref('admin','audit'),

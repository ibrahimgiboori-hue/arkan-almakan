...
export const WORK_COMPLETION_POLICY = Object.freeze({
  ...
  dirtyRule: 'dirty-exists-only-when-an-organ-declares-real-unsaved-progress',
  navigationGuardRule: 'anatomical-navigation-must-not-discard-declared-unsaved-progress-silently',
  navigationChoices: Object.freeze(['continue-current-work','save-draft-if-supported','discard-and-navigate']),
  discardTruth: 'discarding-may-lose-unsaved-progress-and-must-say-so-explicitly',
  browserExitGuard: 'dirty-session-protects-browser-exit-with-native-beforeunload-warning',
  ...
  routeChangePolicy: 'new-route-resets-session-to-idle-not-working',
  ...
  bodyMustNotInferDirtyFromOrdinaryBrowsing: true,

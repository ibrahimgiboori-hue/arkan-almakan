...
export const AREAS = Object.freeze([
  {
    key: 'home',
    ...MODULES.home,
    items: [{ href: '/dashboard', label: 'الرئيسية' }],
  },
  {
    key: 'projects',
    ...MODULES.projects,
...
// واجهة الاختصارات القديمة أوقفت في مرحلة «القلب أولاً».
// نبقي التصديرين مؤقتًا فارغين للتوافق مع أي استيراد قديم إلى أن يثبت عدم استخدامه ثم نحذفهما.

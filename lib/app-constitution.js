...
export const ROLE_BUNDLES = Object.freeze({
  ...
  project_supervisor: {
    label: 'مشرف مشروع',
    actions: [PERMISSION_ACTIONS.VIEW,PERMISSION_ACTIONS.CREATE,PERMISSION_ACTIONS.EDIT,PERMISSION_ACTIONS.EXPORT],
...
export function canForwardBetweenModules(grant) {
  return Boolean(grant && grant.actions?.includes(PERMISSION_ACTIONS.FORWARD) && grant.approvalLevel === APPROVAL_LEVELS.TRANSFER);
}

...
export const AREAS = Object.freeze([
  ...
  },
  {
    ...
    items: [
      ...
      // المسار القديم الشامل يبقى مخفيًا إلى أن تكتمل هجرة كل وظائفه؛
      // لا يُستخدم كنقطة دخول ملاحية موازية لتشغيل المشروع.
      ...
      // مسار توافق قديم فقط. تقارير التايم شيت المرئية تعيش داخل المشروع بجوار الحضور.
      { href: '/dashboard/site-operations/reports', label: 'تقارير التايم شيت', hidden: true },
      { href: '/dashboard/site-operations/data-safety', label: 'سلامة بيانات التشغيل', hidden: true },
    ],
  },
  {
    key: 'workforce',
...
// ملاحة المشروع نفسها جزء من الدستور؛ الشاشات لا تعرّف شرائط محلية موازية.
// الترتيب يعكس رحلة العمل الفعلية: تجهيز العمالة ثم التسجيل ثم ناتجه مباشرة،
// ثم العمليات اليومية، ثم المالية التشغيلية، ثم إدارة التنفيذ والمتابعة.
...
export function normalizeProjectView(value) {
  if (value === 'exec') return 'scope'; // المسار التشغيلي القديم «التنفيذ» اندمج في النطاق والإسناد.

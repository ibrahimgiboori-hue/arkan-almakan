...
// داخل المشروع «موقف المشروع» باب مباشر، وبقية الوظائف مجمعة في عوالم العمل الحقيقية.
// القائمة تعرض عنوان كل عالم دائمًا، ولا تفتح إلا عالمًا واحدًا في اللحظة نفسها.
export const PROJECT_NAV_GROUPS = Object.freeze([
  {
    key: 'status',
    label: 'موقف المشروع',
    items: Object.freeze([
      { key: 'overview', label: 'موقف المشروع', view: 'overview' },
    ]),
  },
  {
    key: 'operations',

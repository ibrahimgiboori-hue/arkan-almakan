...
// أقسام البوابات ليست أدوات مرنة: أب القسم هو بوابته حصريًا ولا يجوز لذاكرة الانطلاق تجاوزه.
...
export function logicalBackTarget(currentPath,fallback=WORKSPACE){
  ...
  // قاعدة قطعية: القسم داخل البوابة يرجع إلى البوابة التي ينتمي إليها دائمًا.
  // لا launch origin ولا browser history يملك حق تجاوز هذه العلاقة.

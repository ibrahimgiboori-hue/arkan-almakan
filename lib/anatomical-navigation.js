...
// هوية «أركان المكان» مرئية بهدوء في جسم الـShell، لكنها ليست عقدة ملاحة قابلة للنقر.
// «مركز العمل» يبقى وضع الخمول الطبيعي للمساحة الكبيرة، وليس بوابة إضافية داخل الشجرة.
...
export const PERSISTENT_NAVIGATION_POLICY = Object.freeze({
  id: 'persistent-navigation-tree-v1',
  productIdentityRole: 'visible-shell-identity-not-navigation-node',
...
// اسم قديم محفوظ مؤقتًا للتوافق مع أي مستورد لم يُنقل بعد.
// المصدر الدستوري الجديد هو PERSISTENT_NAVIGATION_POLICY.
export const IMPLICIT_CONSCIOUSNESS_POLICY = PERSISTENT_NAVIGATION_POLICY;

// منظور المستخدم موجود في الجسد. عند الخمول يظهر «مركز العمل» تلقائيًا في
// المساحة الكبيرة، وعند اختيار بوابة يفسح المكان للعمل من دون أن يتحول إلى عقدة قائمة.
...
// جذر شجرة البوابات المنطقي. يبقى مفهومًا معماريًا حتى لو كانت الشجرة نفسها ظاهرة دائمًا.
...
// أبقى التصدير للتوافق أثناء الهجرة، لكن مركز العمل لا يعود كرابط داخل القائمة.

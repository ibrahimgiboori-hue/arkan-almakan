...
// بعد دخول أي بوابة يصبح جسم الصفحة «صالة البوابة الداخلية» لا فهرسًا ثانيًا.
// هذه هي القاعدة التي تبدأ بوابة المشاريع بتطبيقها ثم ترثها بقية البوابات:
// العمل الحي أولًا، والسجل/التاريخ طبقة ثانية، وأدوات البوابة تبقى في الملاحة المساعدة.
export const INTERIOR_PORTAL_HALL_POLICY = Object.freeze({
  id:'interior-portal-hall-v1',
  role:'work-first-portal-body',
  ...
  bodyMustAnswer:'what-needs-work-now',

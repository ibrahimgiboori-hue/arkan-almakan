...
export const SYSTEM_VERSION = '2.13.0-constitution';
...
export const CONSTITUTION = Object.freeze({
  ...
  financialLifecycle: Object.freeze({
    id: 'financial-clock-v1',
    principle: 'every-financial-source-must-expose-earned-settled-paid-and-net-outstanding-state',
    clockPolicy: 'financial-source-has-origin-earned-settlement-payment-and-outstanding-timestamps-and-values',
    settlementAuthority: 'canonical-settlement-events-only',
    paymentAuthority: 'canonical-treasury-or-source-payment-events-only',
    outstandingPolicy: 'budget-consumes-net-outstanding-not-gross-source-value',
    ...
    sourceTruthPolicy: 'never-rewrite-source-payment-truth-to-simulate-outstanding-state',
    contractorFormulaPolicy: 'earned-plus-reimbursable-plus-approved-additions-minus-charges-minus-advances-minus-settled-or-paid',
    partialSettlementPolicy: 'partial-settlement-reduces-outstanding-by-settled-amount-only',
    zeroOutstandingPolicy: 'fully-settled-items-remain-in-actual-history-but-leave-current-funding-need',

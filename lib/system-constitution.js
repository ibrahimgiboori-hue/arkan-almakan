...
export const SYSTEM_VERSION = '2.14.0-constitution';
...
export const CONSTITUTION = Object.freeze({
  ...
  buildPhase: Object.freeze({
    id: 'active-build-flexibility-v1',
    phase: 'construction',
    principle: 'build-data-must-remain-correctable-without-premature-freezing',
    operationalEditPolicy: 'operational-name-value-date-and-configuration-are-editable-during-build',
    estimateEditPolicy: 'estimate-name-value-date-and-configuration-are-editable-during-build',
    financialChangeIntentPolicy: 'financial-or-timing-change-asks-correction-or-forward-effective-change',
    correctionPolicy: 'correction-restates-affected-history-immediately',
    forwardChangePolicy: 'forward-change-applies-from-current-cycle-and-preserves-prior-values',
    descriptiveChangePolicy: 'descriptive-changes-save-directly-without-financial-intent-dialog',
    overprotectionPolicy: 'do-not-freeze-build-data-merely-because-it-was-generated-referenced-or-used-in-an-estimate',
    canonicalFactException: 'treasury-settlement-and-other-final-financial-events-remain-facts-unless-reversed-by-governed-reversal',
    forbidPrematureHistoricalFreeze: true,
    forbidDescriptiveEditBlocking: true,
  }),
  financialLifecycle: Object.freeze({
    id: 'financial-clock-v2',
    principle: 'every-financial-source-must-expose-earned-approved-actual-paid-and-net-outstanding-state',
    subjectPolicy: 'financial-case-is-lifecycle-wrapper-not-parallel-ledger',
    ...
    settlementAuthority: 'contractor-settlement-freezes-net-payable-for-bounded-source-batch',
    actualAuthorityPolicy: 'actual-authority-is-source-specific-approved-financial-fact',
    contractorActualAuthority: 'final-approved-contractor-settlement',
    ...
    outstandingPolicy: 'net-outstanding-is-approved-actual-minus-effective-posted-payments',
    sourceTruthPolicy: 'raw-operational-source-remains-source-of-origin-and-is-not-rewritten-as-ledger',
    sourceConsumptionPolicy: 'consumed-source-must-not-reenter-another-active-settlement',
    correctionPolicy: 'final-settlement-or-payment-corrects-through-governed-reversal-not-silent-rewrite',
    reversalPolicy: 'void-posted-payments-before-reversing-final-settlement',
    gitDatabaseParityPolicy: 'every-live-financial-function-trigger-view-must-have-versioned-migration-source',
    provisionalBuildPolicy: 'approved-internal-budget-sources-remain-outstanding-until-canonical-settlement-or-payment-proves-reduction',
    zeroOutstandingPolicy: 'fully-paid-items-remain-in-actual-history-but-leave-current-funding-need',
    ...
    forbidDoubleCountingAcrossSourceAndSettlement: true,
    forbidGrossValueAsOutstandingWhenSettlementExists: true,
    forbidLiveFinancialDbLogicWithoutMigration: true,
  }),
  operatingBudget: Object.freeze({
    id: 'company-operating-budget-v4',
    ...
    planningLifecycle: 'estimate-then-actual-then-treasury-paid',
    actualPaymentSource: 'treasury_movements',
    sourcePolicy: 'manual-external-estimates-plus-approved-internal-net-outstanding-sources-only',
    externalEstimatePolicy: 'external-to-system-forecast-values-are-manual-and-editable',
    internalSourcePolicy: 'internal-values-enter-funding-need-only-when-earned-or-due-and-not-fully-settled',
    internalActualPolicy: 'approved-internal-source-actuals-are-calculated-automatically-from-source-truth',
    monitoringPolicy: 'same-monthly-budget-tree-supports-plan-and-monitoring-modes-without-parallel-page-engine',
    monitoringExternalActualPolicy: 'external-source-actuals-are-entered-manually',
    monitoringInternalActualPolicy: 'internal-source-actuals-are-read-only-and-calculated-from-approved-source',
    settlementConsumptionPolicy: 'financial-clock-net-outstanding-is-the-only-internal-funding-need-value',
    provisionalOutstandingPolicy: 'until-financial-clock-is-complete-approved-internal-sources-are-treated-as-outstanding-unless-explicit-canonical-payment-or-settlement-exists',
    estimateEditPolicy: 'metadata-direct-financial-change-requires-correction-or-current-cycle-intent',
    correctionPolicy: 'restate-estimate-facts-only-never-actual-or-paid',
    forwardChangePolicy: 'new-effective-version-from-current-cycle',
    monthlyFundingReportPolicy: 'same-statement-estimate-actual-paid-with-adjustable-safety-margin',
    fundingTargetPolicy: 'monthly-due-plus-required-reserve-times-safety-margin',
    ...
    historyPolicy: 'estimate-corrections-may-restate-estimates-but-actual-and-paid-facts-are-immutable',
    ...
    forbidEstimateCorrectionFromOverwritingActual: true,
    forbidAutomaticForecastFromInternalOperationalData: true,
    forbidInternalSourceDoubleCounting: true,

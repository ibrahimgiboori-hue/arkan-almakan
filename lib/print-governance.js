export const PRINT_GOVERNANCE_VERSION = '1.13';
...
export const PRINT_DOCUMENTS = Object.freeze({
  ...
  claim_documents: {
    ...
    note: 'مربوط بمحرك الدستور وبطبقة projects-finance المركزية ومحرك الإجراءات وشبكة الصفحة الأم والموازنة العامة 1.13، مع توزيع دلالي لأعمدة البنود، وإعادة بناء آمنة للشبكة عند الانتقال بين مستندات ذات أعداد أعمدة مختلفة. بانتظار اجتياز المراجعة البصرية للحالات الأربع قبل Governed.',
  },
  quotation: {

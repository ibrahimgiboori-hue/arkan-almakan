export const PRINT_GOVERNANCE_VERSION = '1.2';
...
export const PRINT_DOCUMENTS = Object.freeze({
  leave_request: {
    ...
    note: 'يستخدم PrintFrame ومحرك إجراءات مشترك، ويحتاج استكمال شكل الإجراءات واختبارات الدستور قبل الاعتماد النهائي.',
  },
  claim_documents: {
    label: 'دورة المستخلص',

export const PRINT_GOVERNANCE_VERSION = '1.16';
...
export const PRINT_DOCUMENTS = Object.freeze({
  ...
  timesheet_report: {
    label: 'تقارير التايم شيت ونموذج الحضور الورقي',
    family: 'site-operations',
    status: PRINT_STATUS.MIGRATING,
    routes: ['/print/timesheet'],
    governedVersion: null,
    note: 'مرتبط بإطار الصفحات الدستوري والهوية المركزية. التقرير الخارجي يخفي الأجور، ويميّز الغياب المسجل عن غير المسجل، ويعامل صف العامل كوحدة ذرية لا تنقسم بين صفحتين، مع نموذج يومي يدوي للمشرف.',
  },
  expense_report: {
    ...
    governedVersion: null,
    note: 'تقرير فترة للمصروفات التشغيلية المحفوظة في قاعدة البيانات، مرتبط بدستور الطباعة المركزي والهوامش والهوية العامة.',
  },
  timesheet_blank: {
    label: 'نموذج حضور عمال مقاول — فارغ',
    family: 'site-operations',
    status: PRINT_STATUS.GOVERNED,
    routes: ['/print/timesheet/blank'],
    governedVersion: '1.16',

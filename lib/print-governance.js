export const PRINT_GOVERNANCE_VERSION = '3.3';
...
// هذا السجل يحتوي أسطح الطباعة الفعلية التي يملك القبطان هندستها، سواء كان مسارها
// تحت /print أو صفحة مخصصة لا تعرض إلا المستند وأوامر الطباعة.
export const PRINT_DOCUMENTS = Object.freeze({
  ...
  payroll_run: {
    ...
    routes:['/print/payroll/[id]','/print/external-payroll/[batchId]'], governedVersion:'3.2',
    layout:Object.freeze({ orientation:PRINT_ORIENTATION.LANDSCAPE }),
  },
  external_payroll_payslip: {
    label:'قسيمة راتب عميل خارجي', family:'hr', status:PRINT_STATUS.GOVERNED,
    routes:['/print/external-payroll/[batchId]/payslip/[lineId]','/dashboard/attendance/payroll/[batchId]/payslip/[lineId]'], governedVersion:'3.2',
  ...
  timesheet_report: {
    label:'تايم شيت شهري ونموذج حضور ورقي', family:'site-operations', status:PRINT_STATUS.GOVERNED,
    routes:['/print/timesheet'], governedVersion:'3.2',
    layout:Object.freeze({ orientation:PRINT_ORIENTATION.LANDSCAPE }),
  },
  external_contractor_timesheet: {
    label:'تايم شيت شهري لمقاول خارجي', family:'site-operations', status:PRINT_STATUS.GOVERNED,
    routes:['/print/contractor-timesheet/[id]'], governedVersion:'3.2',
    layout:Object.freeze({ orientation:PRINT_ORIENTATION.LANDSCAPE }),
  },
  expense_report: {
  ...
  treasury_voucher: {
    label:'سندات الخزينة', family:'corporate-finance', status:PRINT_STATUS.GOVERNED,
    routes:['/print/treasury-voucher/[id]'], governedVersion:'3.3',
    layout:Object.freeze({
      orientation:PRINT_ORIENTATION.PORTRAIT,
      letterheadSource:PRINT_LETTERHEAD_SOURCE.NONE,
  ...
  approval_record: {
    label:'نسخة الاعتماد', family:'governance', status:PRINT_STATUS.GOVERNED,
    routes:['/print/approval/[id]'], governedVersion:'3.3',
    layout:Object.freeze({
      orientation:PRINT_ORIENTATION.PORTRAIT,
      letterheadSource:PRINT_LETTERHEAD_SOURCE.DIGITAL,
    }),

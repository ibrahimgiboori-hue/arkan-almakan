export const PRINT_GOVERNANCE_VERSION = '1.7';
...
export const PRINT_DOCUMENTS = Object.freeze({
  leave_request: {
    ...
    governedVersion: '1.7',
    note: 'خاضع للدستور ومراجع على مبدأ الاتساق والوزنية: المحاذاة يحددها سياق الكتلة والصف/العمود، بينما اتجاه اللغة يحفظ ترتيب المحتوى الداخلي فقط.',
  },
  claim_documents: {
    label: 'دورة المستخلص',
    ...
    note: 'مربوط بمحرك الدستور وبطبقة projects-finance المركزية ومحرك الإجراءات والوزنية التفاعلية وسياسة الاتساق 1.7. بانتظار اجتياز المراجعة البصرية للحالات الأربع قبل Governed.',
  },
  quotation: {

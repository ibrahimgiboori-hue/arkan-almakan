export const PRINT_GOVERNANCE_VERSION = '3.0';
...
export const PRINT_FAMILY_LAYOUTS = Object.freeze({
  'projects-finance': Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
  'corporate-finance': Object.freeze({ sideMm:16, orientation:PRINT_ORIENTATION.PORTRAIT }),
  hr: Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
  commercial: Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
  governance: Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
  'general-documents': Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
  'site-operations': Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
  recruitment: Object.freeze({ sideMm:19, orientation:PRINT_ORIENTATION.PORTRAIT }),
});
...
export const PRINT_DOCUMENTS = Object.freeze({
  ...
  operating_budget_report: {
    ...
    routes:['/print/operating-budget'], governedVersion:'3.0',
    layout:Object.freeze({
      sideMm:14,
...
/*
 * مرحلة هجرة فقط للمطبوعات التي لم تنتقل بعد إلى حدود التدفق المقاسة.
 * لا يستخدمها القبطان V3، وسيتم حذفها عند إحلال آخر مستهلك قديم.
 */
...
export function printGovernanceClassName(documentKey, extra='') {
  const definition=getPrintDefinition(documentKey);
  const orientation=getPrintOrientation(documentKey);
  return [
    'print-constitution',

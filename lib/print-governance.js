export const PRINT_GOVERNANCE_VERSION = '1.6';
...
export const PRINT_FAMILY_LAYOUTS = Object.freeze({
  'projects-finance': Object.freeze({ sideMm: 15 }),
});
...
export const PRINT_DOCUMENTS = Object.freeze({
  leave_request: {
    ...
    governedVersion: '1.4',
    note: 'خاضع للدستور: شبكة Excel وإجراءات مركزية وتوقيع يدوي موحد. قواعد 1.6 العامة ومنها الوزنية والضبط التفاعلي لا تتعارض مع النموذج المعتمد، ويعاد فحصه عند أي تعديل بصري لاحق.',
  },
  claim_documents: {
    label: 'دورة المستخلص',
    ...
    note: 'مربوط بمحرك الدستور وبطبقة projects-finance المركزية ومحرك الإجراءات والوزنية التفاعلية. بانتظار اجتياز المراجعة البصرية للحالات الأربع قبل Governed.',
  },
  quotation: {

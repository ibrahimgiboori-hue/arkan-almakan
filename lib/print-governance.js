export const PRINT_GOVERNANCE_VERSION = '1.17';
...
export const PRINT_DOCUMENTS = Object.freeze({
  ...
  expense_report: {
    ...
    layout: Object.freeze({
      pagination: Object.freeze({ firstPageRows: 13, continuationRows: 18 }),
    }),
    note: 'تقرير فترة للمصروفات التشغيلية المحفوظة في قاعدة البيانات. الصفوف وحدات ذرية، رأس الجدول يتكرر في كل صفحة، منطقة الفوتر محجوزة ولا يدخلها المحتوى، والإجمالي يظهر في الصفحة الأخيرة.',
  },
  timesheet_blank: {

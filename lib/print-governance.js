export const PRINT_GOVERNANCE_VERSION = '1.11';
...
export const PRINT_DOCUMENTS = Object.freeze({
  ...
  claim_documents: {
    ...
    note: 'مربوط بمحرك الدستور وبطبقة projects-finance المركزية ومحرك الإجراءات وشبكة الصفحة الأم والموازنة العامة 1.10. بانتظار اجتياز المراجعة البصرية للحالات الأربع قبل Governed.',
  },
  quotation: {

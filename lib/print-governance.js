export const PRINT_GOVERNANCE_VERSION = '1.8';
...
export const PRINT_DOCUMENTS = Object.freeze({
  leave_request: {
    ...
    governedVersion: '1.7',
    note: 'خاضع للدستور حتى الإصدار 1.7، مع فصل المحاذاة عن اتجاه اللغة. ينتقل إلى شبكة الصفحة الأم عند دخوله دفعة الهجرة التالية.',
  },
  claim_documents: {
    label: 'دورة المستخلص',
    ...
    note: 'مربوط بمحرك الدستور وبطبقة projects-finance المركزية ومحرك الإجراءات وشبكة الصفحة الأم 1.8. بانتظار اجتياز المراجعة البصرية للحالات الأربع قبل Governed.',
  },
  quotation: {

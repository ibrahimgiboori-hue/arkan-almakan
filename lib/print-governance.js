export const PRINT_GOVERNANCE_VERSION = '1.4';
...
export const PRINT_DOCUMENTS = Object.freeze({
  leave_request: {
    ...
    governedVersion: '1.4',
    note: 'خاضع للدستور: شبكة Excel وإجراءات مركزية وتوقيع يدوي موحد. قواعد 1.4 لا تتعارض مع النموذج المعتمد.',
  },
  claim_documents: {
    label: 'دورة المستخلص',
    ...
    note: 'مربوط بمحرك الدستور وبطبقة projects-finance المركزية ومحرك التوقيع المركزي. بانتظار الاعتماد البصري للحالات الأربع قبل Governed.',
  },
  quotation: {

...
export const NAVIGATION_CONSTITUTION_VERSION = '1.3';
...
export const NAVIGATION_POLICY = Object.freeze({
  ...
  portalSectionParent: 'strict-owning-portal',
  portalSectionBackPriority: 'before-launch-origin-and-browser-history',
  crossPortalBackFromSection: 'forbidden',
  ...
  // منصة الأعمال ليست صفحة ولا قشرة ثانية. الشريط الحالي هو سطح الملاحة الوحيد.
  parallelWorkspaceShell: 'forbidden',
  workPlatformPage: 'forbidden',
  portalToolGrouping: 'inside-current-navigation-only',
  portalToolGroupingSource: 'portal-section-constitution',
  duplicatedPortalMap: 'forbidden',
  deadLegacyNavigationFiles: 'must-be-deleted-not-disabled',
});

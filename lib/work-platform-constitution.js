...
// القاعدة: سياق واحد نشط، إجراء مباشر رئيسي واحد، وكل أداة لها موضع مرئي واحد فقط.
// جميع البوابات ترث هندسة واحدة حتى يكون الانتقال بينها «مشية قمر»: الهيكل ثابت والمحتوى فقط يتغير.

export const WORK_PLATFORM_LAYOUT_POLICY = Object.freeze({
  layers: Object.freeze(['context','direct-work','management']),
  sharedContextBaseline: true,
  sharedDirectBandGeometry: true,
  oneVisibleEntryPerDestination: true,
...
// العمل المباشر في البوابات العامة. أي href يظهر هنا يُحذف من طبقة الإدارة في المستوى نفسه.
// الهدف ليس كثرة الاختصارات؛ بل وجود نقطة بدء واضحة بنفس هندسة بوابة المشاريع.
export const PORTAL_DIRECT_WORK = Object.freeze({
  ...
  finance: Object.freeze({
    ...
    secondaryHref: null,
    secondaryCopy: 'المراجعة والاعتماد تبقى في طبقة الإدارة أدناه حتى لا تتكرر الوجهة.',
  }),
...
// ترتيب الأقسام الثانوية ثابت ومقصود في بوابة المشاريع:
// التقارير ← المالية ← التنفيذ ← ملف المشروع.
// الأدوات التحليلية الجديدة تدخل هذه الأقسام نفسها ولا تخلق مستوى خامسًا.
export const WORK_PLATFORM_SECONDARY_SECTIONS = Object.freeze([
  ...
  Object.freeze({
    ...
    label: 'المالية',
    shortLabel: 'المالية',
    description: 'العهدة والدفعات والمستخلصات والضمانات والتحكم المالي في تكلفة المشروع وسيولته.',

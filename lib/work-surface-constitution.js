...
export const WORK_SURFACE_POLICY = Object.freeze({
  ...
  navigationVisibilityPolicy: 'hidden-until-explicitly-called',
  navigationHierarchyPolicy: 'progressive-drill-in-no-stacked-accordions',
  pinnedNavigationPolicy: 'reserve-space-on-desktop-overlay-on-touch',

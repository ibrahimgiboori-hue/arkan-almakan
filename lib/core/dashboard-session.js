import { normalizeActionContext } from '@/lib/action-context';
import { buildDashboardAccess } from '@/lib/core/dashboard-access';

// يحوّل لقطة البنية التحتية إلى قرار جلسة نقي. لا توجيه صفحات، لا CSS، لا نصوص عرض، ولا Supabase هنا.

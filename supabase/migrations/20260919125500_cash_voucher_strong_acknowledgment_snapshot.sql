...
set legal_text_snapshot = case
  when voucher_type='payment' then
    'وأقر أنا المستفيد بأنني استلمت فعليًا وكاملًا المبلغ المبين في هذا السند رقمًا وكتابةً عن الاستحقاق الموضح فيه، بعد اطلاعي على جميع بيانات السند وفهمي لمضمونه وسبب الصرف وطريقة الوفاء به، وقد تبين لي مقدار المبلغ وسببه وطريقة سداده بيانًا نافيًا للجهالة والغموض، وأن توقيعي على هذا السند يعد إقرارًا مني بصحة واقعة الاستلام والبيانات المتعلقة بها، وأن الاستلام تم برضاي واختياري ودون إكراه أو تدليس أو غلط، ويكون هذا الإقرار حجة عليّ في حدود المبلغ وسبب الصرف المبينين صراحة في هذا السند، دون أن يعد إبراءً عامًا عن أي حقوق أو التزامات أخرى غير منصوص عليها فيه.'
  else
